...
import Centrale.server.ICentrale;
...
public class BalieServer extends Application {
    ...
    public boolean startBalie(String nameBank) {
            ...
            try {
                ...
                out.close();
                this.registry = LocateRegistry.getRegistry(address,1099);
                registry.list();
                this.iCentrale = (ICentrale) this.registry.lookup("OverBoekCentrale");
